...
6. Interface recebeu estados indisponiveis explicitos, cobertura MTF, timezone (parcial — so no carimbo do cabecalho; journal/trades/noticias ainda sem fuso, ver UX-005/REV-CC-01), foco visivel, alvos de toque, grafico mobile adaptativo e calculadora limitada contra `NaN`/infinito.
