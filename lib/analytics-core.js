(function (root, factory) {
  ...
  function evaluateSignalTransition(state, snapshot) {
    ...
    var nextState = Object.assign({}, state, { barsHeld: barsHeld, maePct: maePct, mfePct: mfePct });
  ...
  /**
   * Model ruleset registry: weights, caps and thresholds for 1.0.0-preview.5.
  ...
  var RULESET = {
    ...
    rulesetVersion: '1.0.0-preview.5',
