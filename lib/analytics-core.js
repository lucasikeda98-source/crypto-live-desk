(function (root, factory) {
  ...
  function evaluateAlertTransitions(previous, current, config) {
    ...
    if (rules.scoreCross !== false && prevScore !== null && currScore !== null) {
      ...
      [{ level: 60, label: 'entrada favoravel' }, { level: 42, label: 'entrada com confirmacao' }, { level: -42, label: 'entrada vendedora com confirmacao' }, { level: -60, label: 'entrada vendedora favoravel' }].forEach(function (threshold) {
